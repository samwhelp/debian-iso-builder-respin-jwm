...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/debian-iso-builder-respin-jwm/tree/main/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/debian-iso-builder-respin-jwm/tree/main/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/debian-iso-builder-respin-jwm/tree/main/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [debian-iso-builder-respin-jwm](https://github.com/samwhelp/debian-iso-builder-respin-jwm)

``` sh
git clone https://github.com/samwhelp/debian-iso-builder-respin-jwm.git
```


> change dir to `debian-iso-builder-respin-jwm`

``` sh
cd debian-iso-builder-respin-jwm
```
...
> The resulting ISO file will be placed on `debian-iso-builder-remix-jwm/dist`
